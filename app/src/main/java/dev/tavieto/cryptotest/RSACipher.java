...
public class RSACipher {
    ...
    public String decrypt(String result, PrivateKey key)
            throws NoSuchAlgorithmException,
            NoSuchPaddingException,
            InvalidKeyException,
            IllegalBlockSizeException,
    ...
    public static PublicKey stringBase64ToPublicKey(String publicKeyString)
            throws NoSuchAlgorithmException,
            NoSuchPaddingException,
            InvalidKeyException,
            IllegalBlockSizeException,
    ...
    public static PrivateKey stringBase64ToPrivateKey(String privateKeyString) {
